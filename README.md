...
Archify is a rendering and validation system for Cursor, Claude Code, Codex CLI, OpenCode, GitHub Copilot, and WorkBuddy. Agents produce typed JSON IR; Archify deterministically compiles it into HTML/SVG.
